                  ...
                  <div className="row g-4">
                     ...
                     <div className="col-lg-4 col-sm-6">
                        <div className="project__item">
                           <div className="project__item-inner">
                              <div className="project__item-thumb">
                                 <Image src="/images/igo/item/02.jpg"
                                    width={500}
                                    height={500}
                                    alt="IGO cover"
                                 />
                        ...
                        <div className="project__item">
                           <div className="project__item-inner">
                              <div className="project__item-thumb">
                                 ...
                                 />
                                 <span className="badge">
                                    <Image src="/images/chain/aval.png"
                                       width={35}
                                       height={35}
                                       alt="chain logo"
                                    />
                           ...
                           <div className="project__item-inner">
                              ...
                              <div className="project__item-content">
                                 <div className="project__item-top">
                                    <div className="project__item-author">
                                       <Link href="#">
                                          <Image src="/images/igo/author/6.png"
                                             width={80}
                                             height={80}
                                             alt="author image"
                                          />
                     ...
                     <div className="col-lg-4 col-sm-6">
                        <div className="project__item">
                           <div className="project__item-inner">
                              <div className="project__item-thumb">
                                 <Image src="/images/igo/item/06.jpg"
                                    height={500}
                                    width={500}
                                    alt="IGO cover"
                                 />
                              ...
                              <div className="project__item-content">
                                 <div className="project__item-top">
                                    <div className="project__item-author">
                                       <Link href="#">
                                          <Image src="/images/igo/author/5.png"
                                             width={80}
                                             height={80}
                                             alt="author image"
                                          />
